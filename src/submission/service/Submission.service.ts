...
export class SubmissionsService {
    ...
    async createSubmission(createSubmission: createSubmissionDto) {
        ...
        if (!user) { throw new HttpException("Nor Found user", HttpStatus.BAD_REQUEST) }
        if (!task) { throw new HttpException("Not Found this task", HttpStatus.BAD_REQUEST) }
        else {
    ...
    async gradeSumminssion(update: updateGradeDto) {
        ...
        if (!submission) { throw new HttpException("Not found submission", HttpStatus.BAD_REQUEST) }
        else {
